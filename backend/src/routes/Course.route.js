...
const {createCourse, updateCourse, deleteCourse, togglePublish, getMyCourses} = require("../controllers/teacher.controller")
const {publicCourses, viewCoursePublic, getRandomCourses } = require("../controllers/public.controller")
